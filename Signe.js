...
import image_1 from './assets/usu2.png'
const Signe = () => {
  return(
    <View style={styles.container}>
      <Text style={styles.title}>Iniciar</Text>
      <Text style={styles.title_2}>Sesión</Text>
      <Text style={styles.subtitle}>Como establecimiento:</Text>
      <Image
        source = {image}
        style={styles.image}
      />
      ...
      <TouchableOpacity
        onPress={() => Alert.alert("Dirigiendo a registro de establecimiento")}
        style={styles.button_2}
      >
        <Text style={styles.buttonText_1}>*Crear establecimiento</Text>
      </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  image_1: {height: 190, width: 340, position: 'absolute', top: 365, textAlign: 'center'},
    button_1 : {backgroundColor: "#C462C8", padding: 10, borderRadius: 10, position: 'absolute', top: 590, left: 230},
